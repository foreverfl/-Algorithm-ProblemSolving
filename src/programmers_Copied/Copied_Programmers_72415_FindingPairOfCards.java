...
public class Copied_Programmers_72415_FindingPairOfCards {
	...
	// 카드 찾으러 이동하기
	private static int cardSearch(int[] pos, int target_card, int[][] copy_board) {
...
//				System.out.println("[" + target_card + "] find! " + next.x + "," + next.y + ":" + move);
	...
	private static Pair checkRoute(int x, int y, int direction, int[][] copy_board) {
		x += dx[direction];
		y += dy[direction];
